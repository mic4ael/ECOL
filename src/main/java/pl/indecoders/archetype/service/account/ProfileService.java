...
public class ProfileService {
	...
	public PersonalInformationsForm preparePersonalInformationsForm(Account account) {
		...
		PersonalInformationsForm form = new PersonalInformationsForm();
	...
	private void prepareBasicInformations(Profile profile, PersonalInformationsForm form) {
	...
	private void prepareAddressInformations(Profile profile, PersonalInformationsForm form) {
	...
	private void prepareBankInformations(Profile profile, PersonalInformationsForm form) {
	...
	public void processPersonalInformationsForm(PersonalInformationsForm form, Account account) {
	...
	private void processAddressInformations(Profile profile, PersonalInformationsForm form) {
	...
	private void processBankInformations(Profile profile, PersonalInformationsForm form) {
